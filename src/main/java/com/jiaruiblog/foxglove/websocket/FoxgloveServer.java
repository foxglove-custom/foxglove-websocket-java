...
import com.jiaruiblog.foxglove.thread.SendSceneUpdateSimulateThread;
...
//            sendCountThread.start();
            ...
            Thread sendSceneUpdateThread = new Thread(new SendSceneUpdateStreamThread(0, 50, session));
